  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-theme-bg-container flex">
      ...
      {loading ? (
        ...
        <div
          style={{ height: isMobile ? "100%" : "calc(100% - 32px)" }}
          className="relative md:ml-[2px] md:mr-[16px] md:my-[16px] settings-panel w-full h-full overflow-y-scroll p-4 md:p-6"
        >
          <form onSubmit={handleSubmit} className="flex w-full">
            <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
              <div className="w-full flex flex-col gap-y-1 pb-6 mb-4">
                <div className="flex gap-x-4 items-center">
                  <p className="text-lg leading-6 font-bold text-white gradient-section-header">
                    {t("llm.title")}
                  </p>
                </div>
